...
import ejs from 'ejs'
import { IApproveDoctorPayload, IUpdateDoctorProfilePayload } from "./doctor.interface"
...
const getAllDoctors = async (query: any) => {
	...
	if (query.specialization) {
		andConditions.push({
			specializations: { equals: query.specialization, mode: "insensitive" },
		});
	}
	...
	if (query.licenseNumber) {
		andConditions.push({
			licensNumber: { equals: query.licenseNumber, mode: "insensitive" },
		});
	}
...
export const DoctorServices = {
	...
	approveDoctor, getAllDoctors, updateDoctorProfile,
